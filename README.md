...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 50093cf1-b436-4735-99d8-d0e46c5e321d
```

> `50093cf1-b436-4735-99d8-d0e46c5e321d` is the password of the certificate, you can change it to any password you want.
